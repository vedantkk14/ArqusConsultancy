...
/** Title, one muted line and a close (X) button. Every dialog and sheet here starts with this. */
@Component({
  ...
  template: `
    ...
    <button type="button" class="x" [attr.aria-label]="'Close ' + title()" (click)="closed.emit()">
...
export class DialogHead {
  ...
  /** The parent closes the dialog or sheet it lives in. */
