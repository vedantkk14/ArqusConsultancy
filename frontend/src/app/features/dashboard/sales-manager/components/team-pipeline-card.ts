...
import { PipelineStage } from '../sales-manager-dashboard.models';
...
/** One bar per status, team-wide counts. Won/Lost are shown too - the whole funnel, not just open. */
@Component({
  selector: 'app-team-pipeline-card',
  imports: [PanelHead, StackedBar],
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'card panel', role: 'region', 'aria-labelledby': 'pipeline-title' },
  template: `
    <app-panel-head title="Team pipeline" subtitle="All statuses, team-wide" headingId="pipeline-title" />
